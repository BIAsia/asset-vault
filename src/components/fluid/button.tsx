      ...
      return (
        ...
        >
          <span
            aria-hidden
            className={cn(
              "absolute inset-0 -z-10 rounded-[inherit] transition-[background-color,transform] duration-80 group-active:scale-[0.98]",
              bgClass
            )}
          />
          {!isIconOnly && LeadingIcon && (
            <LeadingIcon
              size={iconSize}
              strokeWidth={1.5}
              className="relative transition-[stroke-width] duration-80 group-hover:stroke-[2]"
            />
          )}
